...
import { tribonacci } from "../src/fibonacci";

const tester = (sig: number[], n: number, exp: number[]) => it(`tribonacci([${sig[0]}, ${sig[1]}, ${sig[2]}], ${n})`, () => assert.deepStrictEqual(tribonacci(sig, n), exp));
describe("basic tests", () => {
  ...
  tester([1, 1, 0, 1], 3, [1,1,0]);
  tester([1, 1, 1], 3.5, [1,1,1]);
